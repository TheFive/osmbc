...
describe("views/article", function() {
 ...
 //     browser.visit('/article/'+articleId, function(err){
    ...
    describe("onchangeCollection", function() {
      ...
      it("should ignore brackets in a link (No Markdown!)", function(bddone) {
        browser.document.getElementById("collection").value = "Some collection https://www.openstreetmap.org/a_brilliant_map Markdown";
        browser.evaluate("onchangeCollection()");
