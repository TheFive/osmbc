      ...
      it('should send out an email when changing email',function (bddone){
        userModule.findOne({OSMUser:"WelcomeMe"},function(err,user){
          ...
          user.setAndSave("InviteYou",{email:"WelcomeMe@newemail.org"},function (err){
            ...
            var expectedMail = "<h2>Welcome </h2><p>InviteYou has invited you to OSMBC. (May be he just changed your EMail adress in OSMBC)\nYou can login to OSMBC with your OpenStreetMap credentials via OAuth.</p><p><a href=\"https://testosm.bc/osmbc.html\">OSMBC</a> is the tool for the international Weekly OSM and the German Wochennotiz Team to collaborate writing and translating the weekly news.\nSomeone has invited you to join. You can login with your OpenStreetMap credentials, and the above link.</p><p>If you would like to use this email address for OSMBC click on this link: <a href=\"https://testosm.bc/usert/1?verify="+code+"\">Link To Click On.</a></p><p>If you would like to check your User Settings go to<a href=\"https://testosm.bc/usert/1\">User Settings </a>.</p><p>Thanks for supporting Weekly & Wochennotiz.</p><p>Have fun with OSMBC. </p><p>Christoph (TheFive).</p>";
