...
function buildLicenseObject(object, cb) {
  ...
  return function buildLicenseObject(err, json) {
    ...
    for (const k in json) {
      ...
      if ((k === "caniuse-lite@1.0.30001507") || (k === "caniuse-lite@1.0.30001676") || (k === "caniuse-lite@1.0.30001747") || (k === "caniuse-lite@1.0.30001806") || (k === "caniuse-lite@1.0.30001749") || (k === "caniuse-lite@1.0.30001750") || (k === "caniuse-lite@1.0.30001751")) {
